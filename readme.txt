...
NOTE: This module is now depreciated as TMT has released a new API. It is not supported.
...
Setup cron to run at 12.30, 12.31 and 12.35 GMT to make sure that all currency updates are run.
